...
const TerrariumRequestAll: React.FC = () => {
  ...
  const fetchRequests = async () => {
    try {
      ...
      const response = await fetch('https://terarium.shop/api/TerrariumLayout/all', {
        method: 'GET',
        headers: {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Danh sách yêu cầu về terrarium</h1>
          <p className="text-gray-600">Các yêu cầu định giá terrarium từ khách hàng</p>
        </div>
      </div>
...
export default TerrariumRequestAll;