  ...
  return (
    <div className="container mx-auto px-4 py-8 font-roboto">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600">Làm theo từng bước: chọn môi trường → hình dạng → loại bể → tạo mẫu → chọn ảnh → lưu layout.</p>
      </div>
      ...
      {/* Lỗi */}
      {err && (
        <div className="mt-4 p-3 rounded bg-red-50 text-red-700 border border-red-200">{err}</div>
      )}
      ...
      {/* Bước: chọn 1 trong 4 ảnh (có preview full-screen) */}
      {step === 'pickImage' && gen && (
