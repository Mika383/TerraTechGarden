  ...
  const Checkout: React.FC = () => {
    ...
    const depositRaw = paymentOption === 'deposit'
  ...
  try {
      ...
      .map((item) => {
        if (item.accessoryId) {
          return {
            ...
            // unitPrice không cần gửi theo doc, chỉ cần accessoryId/variantId + quantity
          };
        }
        if (item.variantId) {
          return {
    ...
    // 3. Tạo thanh toán qua VNPAY
    const paymentPayload = {
      orderId,
      orderType: paymentOption === 'deposit' ? 'Deposit' : 'Full',
      orderDescription: customerNote || '', // hoặc '' nếu không có
      name: address?.receiverName || '', // lấy tên từ address
    };
    ...
    if (payUrl) {
      // Xóa localStorage sau khi tạo order & chuyển hướng luôn
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  ...
                  <div className="mt-2 text-xs text-gray-700">
                    Đặt cọc 30% để đảm bảo đơn hàng, hỗ trợ chi phí vận chuyển và giảm thiểu rủi ro giao hàng, đặc biệt với sản phẩm dễ vỡ.
                  </div>
                </div>
                {/* Thanh toán toàn bộ */}
                <div
                ...
                >
                  ...
                  <div className="mt-2 text-xs text-gray-700">
                    Giảm ngay <b>10%</b> giá trị đơn hàng, được ưu tiên xử lý trước và nhận nhiều quyền lợi hấp dẫn từ TerraTech!
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="flex gap-4">
                ...
                >
                  <input
                    ...
                    className="mr-2"
                  />
                  {/* <img src={payosLogo} alt="PayOS" className="w-8 h-8 object-cover rounded" /> */}
            ...
            <div className="flex flex-col md:flex-row gap-6 w-full">
              ...
              <div className="flex-1 bg-white rounded shadow p-6">
                ...
                <div className="mt-4 min-h-[80px]">
                  {voucherError && (
                    <div className="text-red-500 text-base">{voucherError}</div>
                  )}
                  {voucher && (
              ...
              <div className="flex-1 bg-white rounded shadow p-6 flex flex-col">
                <div className="flex justify-between items-end mb-3">
                  ...
                  <span className={`text-sm ${customerNote.trim().split(/\s+/).length > 100 ? 'text-red-500' : 'text-gray-500'}`}>
                ...
                <textarea
                  ...
                  onChange={e => {
                    ...
                    if (words.length <= 100) {
                      ...
                      // Nếu quá 100 từ, chỉ giữ lại 100 từ đầu
